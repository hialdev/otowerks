            ...
            <nav class="navbar navbar-light bg-light w-100">
                <div class="container-fluid p-0">
                    ...
                    <ul class="oto-menu d-flex align-items-center list-unstyled text-dark m-0">
                        ...
                        {% for ctg in categorynav %}
                            <li class="nav-item {{active == ctg.slug ? 'active':''}}">
                                <a class="nav-link text-dark" href="/news?c={{ctg.slug}}">{{ctg.name}}</a>
                            </li>
                        {% endfor %}
                        <li class="nav-item {{active == 'video' ? 'active':''}}">
                            <a class="nav-link text-dark" href="{{url('video')}}">Video</a>
                        </li>
                        <li class="nav-item  dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="{{url('news?t=mobil')}}">Mobil</a></li>
                                <li><a class="dropdown-item" href="{{url('news?t=motor')}}">Motor</a></li>
                                <li><a class="dropdown-item" href="{{url('news?t=sport')}}">Sport</a></li>
                            </ul>
                        </li>
                    </ul>
