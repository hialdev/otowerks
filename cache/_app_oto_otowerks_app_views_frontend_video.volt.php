                ...
                <div class="grid">
                    <div class="g-col-12 mb-3">
                        ...
                        <div class="owl-carousel owl-theme featured-news">
                            <div>
                                <a href="<?= $this->url->get('video/slug') ?>" class="d-block text-decoration-none text-dark">
                    ...
                    <div class="g-col-12 g-col-md-6 g-col-lg-4 g-col-xl-3 rounded overflow-hidden bg-white">
                        <a href="<?= $this->url->get('video/slug') ?>" class="d-flex flex-row flex-md-column text-decoration-none text-dark">
