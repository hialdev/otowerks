...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="/assets/backend/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
...
<div class="container-xxl container-p-y">
    ...
    <p class="mb-4 mx-2">Oops! 😖 Permintaan anda tidak dapat ditemukan.</p>
    <a href="<?= $this->url->get($prevUrl) ?>" class="btn btn-primary">Kembali</a>
    <div class="mt-3">
        <img
        src="/assets/backend/img/illustrations/page-misc-error-light.png"
